...
export const metadata: Metadata = {
    ...
    description: 'Practical guides on DLP policy testing, nested JSON exfiltration, Advanced DLP tests, NGFW IPS validation, MITRE ATT&CK simulation, and DLP regex building. Free tools with tutorials.',
};
...
const blogPosts = [
    {
        ...
        description: 'Your DLP blocks the test file every time. So why did sensitive data still walk out the door? 6 blind spots — including nested JSON exfiltration via MCP/API payloads — that lab testing never catches.',
        date: 'Mar 23, 2026',
    ...
    },
    {
        ...
        description: 'There are other DLP and firewall testing tools. Here\'s what ITSecTools does that none of them can: nested JSON exfiltration testing (MCP/API payloads), endpoint DLP detection, 10-vendor regex, PDF reports, and kill chain simulation.',
        date: 'Feb 26, 2026',
        readingTime: '10 min read',
        category: 'Comparison',
        color: '#059669',
    ...
    },
    {
        ...
        description: 'Your DLP says it\'s working. But can it detect SSNs inside nested JSON? Encrypted ZIPs? API payload exfiltration? 5 blind spots including Advanced DLP tests — free with PDF validation report.',
        date: 'Jan 24, 2026',
        readingTime: '10 min read',
        category: 'DLP',
        color: '#6366F1',
