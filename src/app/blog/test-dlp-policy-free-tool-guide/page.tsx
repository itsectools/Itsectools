...
export default function TestDlpPolicyFreeToolGuidePage() {
    ...
    return (
        <div>
            ...
            {/* ─── Phase 4.5: Advanced DLP Tests — Nested JSON Exfiltration ─── */}
            <section style={{ marginBottom: '3rem' }}>
                <div style={phaseCard('#6366F1', '#FFFFFF', '#EEF2FF')}>
                    <div style={phaseLabel('#6366F1')}>PHASE 4.5 — ADVANCED DLP TESTS <span style={{ fontSize: '0.7rem', fontWeight: 600, color: '#DC2626', background: '#FEF2F2', padding: '0.1rem 0.4rem', borderRadius: '3px', marginLeft: '0.5rem' }}>UNIQUE</span></div>
                    <h3 style={{ fontSize: '1.15rem', color: '#0F172A', margin: '0 0 0.75rem 0' }}>
                        Nested JSON Exfiltration — The Blind Spot No One Else Tests
                    </h3>
                    <p style={{ ...bodyText, marginBottom: '0.75rem' }}>
                        AI agents (MCP), REST APIs, and GraphQL mutations all transmit data inside deeply nested JSON structures. What happens when sensitive data ends up buried 4-6 levels deep inside those payloads? <strong>ITSecTools is the only free tool that tests this.</strong>
                    </p>
                    <div style={{ background: 'white', borderRadius: '6px', padding: '1rem', fontSize: '0.88rem', color: '#334155' }}>
                        <strong>How it works:</strong>
                        <ul style={{ margin: '0.5rem 0 0 0', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                            <li>Select data type (PII, PCI, PHI) and nesting depth (2, 4, or 6 levels)</li>
                            <li>Server generates fresh sensitive data and wraps it in a deeply nested JSON-RPC structure</li>
                            <li>The payload is POSTed through your network — DLP must parse the nested JSON to find it</li>
                            <li>Most DLP engines only scan flat text — this test reveals whether yours can handle structured data</li>
                        </ul>
                        <div style={{ marginTop: '0.75rem', padding: '0.5rem 0.75rem', background: '#F8FAFC', borderRadius: '4px', fontSize: '0.82rem', color: '#334155' }}>
                            🔥 <strong>Why this matters:</strong> As AI tools and APIs become standard in enterprise workflows, nested JSON exfiltration is a real and growing attack vector. If your DLP can&apos;t parse deeply nested JSON, an attacker — or a misconfigured AI agent — can leak data undetected.
                        </div>
                    </div>
                </div>
            ...
            <section style={{ marginBottom: '3rem' }}>
                ...
                <div style={{ background: 'white', borderRadius: '8px', padding: '1.25rem', border: '1px solid #E2E8F0', marginBottom: '1rem' }}>
                    ...
                    <ul style={{ margin: '0.5rem 0 0 0', paddingLeft: '1.25rem', lineHeight: 1.9, fontSize: '0.88rem', color: '#475569' }}>
                        <li><strong>Generate a PDF report</strong> — click &quot;Generate Report&quot; after your tests to download a branded scorecard with score gauge, protocol coverage, and gap analysis</li>
                        <li><strong>Share the report</strong> in your next security review — it gives management a clear, visual scorecard of your DLP posture</li>
            ...
            <div className="blog-image-wrapper">
                <Image src="/blog/dlp-validation-report.png" alt="ITSecTools DLP Validation Report — 100% score with MCP protocol tests blocked" width={1200} height={800} />
            </div>
