        ...
        <>
            ...
            <div style={{ maxWidth: '780px', margin: '0 auto', padding: '2rem 1.5rem 4rem', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', color: '#1E293B', lineHeight: 1.7 }}>
                ...
                <ol style={{ paddingLeft: '1.5rem', lineHeight: 2 }}>
                    ...
                    <li><strong>NEW:</strong> <Link href="/dlp" style={{ color: '#6366F1' }}>DLP Validator</Link> &rarr; Advanced DLP Tests &rarr; Nested JSON Exfiltration &rarr; select PCI, depth 6, HTTPS &rarr; send the test and see if your DLP catches credit card data buried 6 levels deep in JSON</li>
                </ol>

                <p>
                    If your DLP passes all seven — including the nested JSON test — you have a solid deployment. If it doesn&apos;t, you know exactly where the gaps are — before an attacker finds them.
                </p>
                ...
                <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0F172A', marginBottom: '0.75rem' }}>
                    Bonus: the blind spot no one is testing — Nested JSON exfiltration
                </h2>

                <p>
                    AI agents, REST APIs, and GraphQL mutations all transmit data inside deeply nested JSON structures. What happens when sensitive data ends up buried 4-6 levels deep inside those payloads?
                </p>
                <p>
                    Most DLP engines scan flat text and file attachments. They don&apos;t parse nested JSON. An attacker — or a misconfigured AI agent — can exfiltrate PII, PCI, or PHI data buried 4-6 levels deep inside a JSON-RPC payload, and your DLP won&apos;t see it.
                </p>
                <p>
                    ITSecTools is the <strong>only free tool</strong> that tests this. The <Link href="/dlp" style={{ color: '#6366F1', fontWeight: 600 }}>Advanced DLP Tests</Link> tab generates fresh sensitive data server-side, wraps it in a deeply nested JSON structure at your chosen depth (2, 4, or 6 levels), and POSTs it through your network. If your DLP doesn&apos;t block it — you&apos;ve found a gap that no other testing tool would have caught.
                </p>

                <div className="blog-image-wrapper">
                    <Image src="/blog/mcp-protocol-testing.png" alt="ITSecTools Nested JSON Exfiltration — PCI data inside MCP/API payloads blocked by DLP" width={1200} height={800} />
                </div>
                ...
                {/* --- PDF Report --- */}
                <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0F172A', marginBottom: '0.75rem' }}>
                    Generate a report your CISO will actually read
                </h2>

                <p>
                    Running tests is half the job. The other half is proving your findings to management. After running any combination of tests, click <strong>Generate Report</strong> to download a branded PDF with a score gauge, protocol coverage breakdown, detailed test results, identified gaps, and actionable recommendations.
                </p>
                <p>
                    No signup, no account, no data leaves your browser. The report generates instantly, client-side.
                </p>

                <div className="blog-image-wrapper">
                    <Image src="/blog/dlp-validation-report.png" alt="ITSecTools DLP Validation Report — 100% score with nested JSON PCI tests blocked" width={1200} height={800} />
                </div>
