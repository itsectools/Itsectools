...
const guides = [
    {
        ...
        title: 'DLP Validator',
        description: 'File uploads (HTTP/HTTPS/FTP), download test documents, raw text POST, file metadata & label checker, regex creator & translator, advanced payload generator, nested JSON exfiltration (MCP/API payloads), and PDF validation report.',
        color: '#6366F1',
        bg: '#EEF2FF',
        icon: (
        ...
        <div>
            ...
            <section style={{ marginTop: '3rem', padding: '2.5rem', background: '#F8FAFC', borderRadius: '12px', border: '1px solid #E2E8F0' }}>
                ...
                <ul style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.8, paddingLeft: '1.25rem', margin: '0 0 1.5rem 0' }}>
                    <li><strong>Data Loss Prevention (DLP)</strong> — Upload sensitive test files, test nested JSON exfiltration for MCP/API payloads (Advanced DLP Tests — unique, no competitor offers this), inspect metadata labels, build vendor-specific regex, generate evasion payloads, and download scored PDF validation reports.</li>
