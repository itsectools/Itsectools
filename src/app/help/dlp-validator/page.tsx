        ...
        <div>
            ...
            <section style={{ background: '#F8FAFC', borderRadius: '12px', padding: '1.5rem 2rem', marginBottom: '2rem', border: '1px solid #E2E8F0' }}>
                ...
                <ol style={{ paddingLeft: '1.25rem', margin: 0, color: '#6366F1', fontSize: '0.9rem', lineHeight: 2 }}>
                    ...
                    <li><a href="#mcp-testing" style={{ color: 'inherit', textDecoration: 'none' }}>Advanced: Nested JSON Exfiltration (MCP/API Payloads)</a></li>
            ...
            <section id="mcp-testing" style={{ marginBottom: '3rem' }}>
                <h2 style={{ fontSize: '1.4rem', color: '#0F172A', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '2px solid #EEF2FF' }}>9. Advanced: Nested JSON Exfiltration (MCP/API Payloads)</h2>
                <p style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.7, marginBottom: '1rem' }}>
                    Tests whether your DLP can detect sensitive data buried inside deeply nested JSON structures — the same format used by AI agents (MCP), REST APIs, and GraphQL mutations. Unlike the raw text POST test, sensitive data is generated <strong>server-side</strong> and wrapped at configurable nesting depths, so the DLP engine must parse the JSON to find it.
                </p>
                ...
                <div style={{ background: '#F8FAFC', borderRadius: '8px', padding: '1.5rem', marginBottom: '1rem', border: '1px solid #E2E8F0' }}>
                    ...
                    <ol style={{ color: '#475569', fontSize: '0.9rem', lineHeight: 1.8, paddingLeft: '1.25rem', margin: 0 }}>
                        ...
                        <li>Click <strong>Send Nested JSON Test</strong>.</li>
                ...
                <div style={{ background: '#F8FAFC', borderRadius: '8px', padding: '1.5rem', marginBottom: '1rem', border: '1px solid #E2E8F0' }}>
                    ...
                    <ul style={{ color: '#475569', fontSize: '0.9rem', lineHeight: 1.8, paddingLeft: '1.25rem', margin: 0 }}>
                        ...
                        <li><strong>API/JSON exfiltration</strong> — AI agents (MCP), REST APIs, and GraphQL mutations transmit data in nested JSON. Can your DLP detect data leaking through these channels?</li>
                    </ul>
                </div>
